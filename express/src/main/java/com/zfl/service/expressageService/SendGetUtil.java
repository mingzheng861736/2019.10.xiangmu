...
public class SendGetUtil {
    ...
    public String get(String ExpressNumber ) throws Exception{
        ...
        Request request = new Request.Builder()
                ...
                .addHeader("cache-control", "no-cache")
                //.addHeader("token","eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJleHAiOjE1Njk4MTQ1NjYsInVzZXJuYW1lIjoid2FuZ3d1In0.wez3sP5s94P8GmLylQAakHAaq5QoTbBLvEMxkNRC-QbXykGRG020raFD4UKsZeTj0HBb3D9cm6B6haxgnQycRg")
                .build();
