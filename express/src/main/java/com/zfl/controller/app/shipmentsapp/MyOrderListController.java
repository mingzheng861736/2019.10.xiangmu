...
public class MyOrderListController {
    ...
    //@RequiresAuthentication
    public Result getOrderInfo(HttpServletRequest request,@RequestParam Integer id){
    ...
    //@RequiresAuthentication
    public Result getOrderNumByEarings (HttpServletRequest request){
        AdminUser adminUser = userJwtService.getUser(request);
        //获取用户当前余额
    ...
    //@RequiresAuthentication
    public Result getOrderNums (HttpServletRequest request){
        return tbOddNumService.getOrderNum(request);
    }
