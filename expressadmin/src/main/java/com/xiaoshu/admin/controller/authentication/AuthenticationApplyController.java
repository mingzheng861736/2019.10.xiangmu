...
public class AuthenticationApplyController {
    ...
    public String authenticationInlet(ModelMap model,Integer id){
        ...
        JSONObject cardNumImage = JSONObject.parseObject(tbUserInfo.getCardNumImage());
        map.put("fullFacePhoto",cardNumImage.getString("fullFacePhoto"));
        map.put("reverseSideAs",cardNumImage.getString("reverseSideAs"));
        map.put("handheldAccording",cardNumImage.getString("handheldAccording"));
    ...
    public ResponseEntity authenticationAudit( Integer id, ServletRequest request){
        ...
        AdminUser user = adminUserService.getById(tbUserInfo.getUserId());
        JSONObject userInfo = JSONObject.parseObject(tbUserInfo.getUserInfoJson());
        ...
        if(map.get("isCertification").equals("0")){
